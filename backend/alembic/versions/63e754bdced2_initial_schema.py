...
Revision ID: 63e754bdced2
Revises: 
Create Date: 2026-09-12 23:46:54.004694
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('base_currency', 'target_currency', name='uq_currency_rate_pair')
    )
    ...
    sa.Column('service_type', sa.Enum('home_visit', 'in_store', 'consultation', name='service_type'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('preferred_currency', sa.Enum('USD', 'GBP', 'PKR', name='supported_currency'), nullable=False),
    ...
    sa.CheckConstraint('booked_count >= 0 AND booked_count <= capacity', name='ck_slot_booked_within_capacity'),
    ...
    sa.Column('recommended_temp_c_range', sa.String(length=50), nullable=True),
    sa.Column('recommended_ph_range', sa.String(length=50), nullable=True),
    ...
    op.create_index(op.f('ix_fish_details_species'), 'fish_details', ['species'], unique=False)
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'order_item_id', name='uq_review_user_order_item')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_fish_details_species'), table_name='fish_details')
